            ...
            <form onSubmit={handleSubmit} className="p-6 space-y-4 text-left overflow-y-auto">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <select defaultValue={product.material_color || ""} name="material_color" className="w-full border border-charcoal/20 bg-transparent px-4 py-2 text-sm focus:border-rose-gold focus:outline-none rounded">
